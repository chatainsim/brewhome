...
- **Volumes d'eau calculés** : eau d'empâtage, eau de rinçage, pré-ébullition et eau totale calculés automatiquement selon le ratio, l'absorption et l'évaporation ; **saisie manuelle possible** pour chacun — le volume réellement attendu après ébullition est recalculé en conséquence et une alerte apparaît si le volume cible ne peut pas être atteint
...
- **Recherche en temps réel** dans chaque catégorie — filtre sur le nom et la sous-catégorie
