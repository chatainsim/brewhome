...
<style>
:root{--bg:#0f0f0f;--card:#1a1a1a;--border:#272727;--text:#e8e0d0;--muted:#888;--amber:@@0@@;--hop:#7ec845;--info:#60a5fa}
...
<header>
  ...
  <div class="subtitle">Mise à jour le @@3@@</div>
  <div class="stats">
    <div><div class="stat-val">@@4@@</div><div class="stat-lbl">Bières</div></div>
    @@5@@
    @@6@@
  </div>
</header>
@@7@@
<footer>Généré par @@8@@</footer>

<div id="lb" onclick="closeLb()">
  <button id="lb-close" onclick="closeLb()" title="@@9@@">✕</button>
